...
st.markdown('**Tip:** Sort this table by magnitude, date/time, depth for further insights. You can click on the three dots to the right of each column header for sorting.')
